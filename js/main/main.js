...
moreClicks.count=0;
var adjustedKey;
//global variables because my js-fu is weak
$(function() {
	...
	function instagridNameFormatter(value, key) {
		...
		if (insta_length >= 20){$('#'+ adjustedKey ).addClass('xxxl-name')}
		else if (insta_length >= 18 && insta_length < 20) { $('#'+ adjustedKey ).addClass('xxl-name') }
